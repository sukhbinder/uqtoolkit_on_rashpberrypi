...
/// default chaos type
#define CHAOS "LU" 
/// default chaos parameter #1
#define ALPHA 0.0  
/// default chaos parameter #2
#define BETA 1.0   
...
/// \brief Program to find PC coefficient of a random variable given a set of data samples
int main(int argc, char *argv[])
{
  ...
  Array2D<double> c_k(npc,nvar,0.e0); // remember, nvar=ndim 
