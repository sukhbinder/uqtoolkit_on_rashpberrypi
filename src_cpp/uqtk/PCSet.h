...
public:
 ...
 /// \brief Get the quadrature weights
  ...
  /// \todo Do not require the output array size to be set initially. Instead, resize it inside the function.
  ...
  /// \note Requires the size of the arrays p1 and p2 to equal the number of PC terms
  /// \todo Do not require the output array size to be set initially. Instead, resize it inside the function.
  ...
  /// \brief Compute the variance fractions of each basis term given coefficient array coef; returns the variance fractions in the array varfrac
  ...
  /// \todo There is no double* version of this function
  /// \todo Add a function that evaluates the analytic norms-squared
