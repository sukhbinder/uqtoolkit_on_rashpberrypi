...
===================================================================================== */
#ifndef FASTLAPLACE_H
#define FASTLAPLACE_H

#include "Array1D.h"
#include "Array2D.h"

/** \file fast_laplace.h
 * The implemenation of 'BCS with Laplace priors' algorithm. 
 */
...
/// produces
/// weights of the retained bases, their corresponding number (in the array 'used'), errorbars,
